...
>(({ className, variant = "default", ...props }, ref) => (
  <ToastPrimitive.Root
    ...
    className={cn(
      ...
      variant === "default" && "border-neutral-200 bg-white dark:border-neutral-700 dark:bg-neutral-900",
      variant === "success" && "border-green-200 bg-green-50 dark:border-green-800 dark:bg-green-950",
      variant === "error" && "border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-950",
      className
    )}
    {...props}
  />
